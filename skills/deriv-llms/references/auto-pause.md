...
Pause an automated trading run. No further contracts will be purchased until the run is resumed.
...
- Request schema: [`auto_pause_request.schema.json`](https://developers.deriv.com/schemas/auto_pause_request.schema.json)
- Response schema: [`auto_pause_response.schema.json`](https://developers.deriv.com/schemas/auto_pause_response.schema.json)
...
|-------|------|----------|-------------|
| `auto_pause` | integer: [1] | Yes | Must be `1` |
| `run_id` | string, pattern ^[\w-]{1,128}$ | Yes | The run ID to pause. |
...
| Field | Type | Required | Description |
|-------|------|----------|-------------|
| `auto_pause` | object | No | Updated details of the paused automated trading run |
| `echo_req` | object | Yes | Echo of the request made. |
| `msg_type` | string: ["auto_pause"] | Yes | Action name of the request made. |
...
_Source: [auto-pause](https://developers.deriv.com/llms/auto-pause.md)._
