# WebSocket Demo Upgrade

**Auth:** required

Request to upgrade the connection to a WebSocket scoped to a demo Options Trading account.
...
- Request schema: [`ws_demo_request.schema.json`](https://developers.deriv.com/schemas/ws_demo_request.schema.json)
- Response schema: [`ws_demo_response.schema.json`](https://developers.deriv.com/schemas/ws_demo_response.schema.json)
...
_Source: [ws-demo](https://developers.deriv.com/llms/ws-demo.md)._
